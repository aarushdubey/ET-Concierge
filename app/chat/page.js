                  ...
                  <>
                    ...
                    {financialTwin.emotionalTriggers?.length > 0 && (
                      <div className="twin-card">
                        ...
                        <div className="profile-tags">
                          {financialTwin.emotionalTriggers.map((t,i) => <span key={i} className="profile-tag">{typeof t === 'string' ? t : t.name || t.type || JSON.stringify(t)}</span>)}
                        </div>
                      </div>
                    )}
                    ...
                    {goals.length > 0 && (
                      <div className="twin-card">
                        ...
                        <div className="profile-tags">
                          {goals.map((g,i) => <span key={i} className="profile-tag">{typeof g === 'string' ? g : g.name || g.goal || JSON.stringify(g)}</span>)}
                        </div>
                      </div>
                    )}
                    {interests.length > 0 && (
                      <div className="twin-card">
                        ...
                        <div className="profile-tags">
                          {interests.map((int,i) => <span key={i} className="profile-tag">{typeof int === 'string' ? int : int.name || int.interest || JSON.stringify(int)}</span>)}
                        </div>
                      </div>
                    )}
                  </>
